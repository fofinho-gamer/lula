...
let elementoPorId = document.getElementById("meuId");  // Corrigido de "getElementsByID" para "getElementById"
...
body.style.backgroundColor = "lightblue";  // Corrigido de "backgroundColorolor" para "backgroundColor"
